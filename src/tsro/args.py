...
from llama_factory.llmtuner.hparams import ModelArguments, DataArguments
...
@dataclass
class TsroModelArguments(ModelArguments):
    """Extend model arguments."""
