...
class TestInlinePromptConstructor(unittest.TestCase):
    def test_global_absolute(self):
        ...
        self.assertEqual(queries[0].label, "1")
        ...
        prompt_constructor(queries)
        expected_prompt = \
            "2024-01-01:[ENT_0,REL_0,ENT_1]\n" \
            "2024-01-01:[ENT_0,REL_1,ENT_1]\n" \
            "2024-01-02:[ENT_0,REL_0,ENT_2]\n" \
            "2024-01-04:[ENT_0,REL_0,ENT_1]\n" \
            "2024-01-04:[ENT_0,REL_1,ENT_2]\n" \
            "2024-01-05:[ENT_0,REL_0,ENT_1]\n" \
            "2024-01-05:[ENT_0,REL_1,ENT_1]\n" \
            "2024-01-06:[ENT_0,REL_0,ENT_"
        self.assertEqual(queries[0].prompt, expected_prompt)
        self.assertEqual(queries[0].label, "1")
        self.assertDictEqual(
    ...
    def test_session_query(self):
        ...
        self.assertEqual(queries[2].label, "1")
        self.assertDictEqual(
            queries[2].candidates,
            {"0": "0", "1": "1", "2": "2"}
        )
